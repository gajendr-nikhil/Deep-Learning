...
def test_for_kitti_dataset(data_dir):
    ...
    assert training_images_count == 578, 'Expected 578 training images, found {} images.'.format(training_images_count)
    assert training_labels_count == 578, 'Expected 578 training labels, found {} labels.'.format(training_labels_count)
